...
**Features**
    ...
    - PNG decoder and encoder :
        ~ supports 8-bits bit depth images
        ...
        ~ supports all reverse filter method (sub, up, average, Paeth)
...
**To-Do-List**
    ...
    - Support bits depths other than 8(16, 32, ...)
    - Using smart pointers instead on buffer pointers
    - Secrease ouput images size : implement filtering methods(only one managed is none(0))
